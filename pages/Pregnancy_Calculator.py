...
def app():
    ...
    if "quick_url" not in st.session_state:
        st.session_state.quick_url = ""
    ...
    st.markdown(f"*Feel free to call this page with some prefilled data to get results easier eg: https:// ...... /Pregnancy_Calculator{st.session_state.quick_url}*")
    ...
    st.session_state.quick_url = f"?calculate_by_option={radiobutton_calculate_by}"
    if radiobutton_calculate_by == "Last Menstrual Period (Start Date)":    
        ...
        st.session_state.quick_url += f"&embryo={radiobutton_embryo}"
